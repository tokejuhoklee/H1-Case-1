...
(
  ...
  "Adresse"    nvarchar(50) NOT NULL DEFAULT '''',
...
(
  ...
  "Notes"       nvarchar(4095) NOT NULL DEFAULT '''',
...
(
  ...
  "Etc"                    nvarchar(4095) NOT NULL DEFAULT '''',
...
(
  ...
  "Customer Rental Contract Text" nvarchar(4095) NOT NULL DEFAULT '''',
...
(
  ...
  "Person id"            int            NOT NULL,
  "Etc"                  nvarchar(4095) NOT NULL DEFAULT '''',
  CONSTRAINT PK_Summerhouse owner PRIMARY KEY (Summerhouse owner id)
)
GO
...
(
  ...
  "Date Start Rent"                 date           NOT NULL DEFAULT GETDATE(),
  "Date End Rent"                   date           NOT NULL DEFAULT GETDATE(),
  "Summerhouse Owner Contract Text" nvarchar(4095) NOT NULL DEFAULT '''',
  "Price"                           money          NOT NULL DEFAULT 0.0,
  CONSTRAINT PK_Summerhouse Owner Contract Relation PRIMARY KEY (Summerhouse Owner Contract id)
)
GO
...
(
  ...
  CONSTRAINT PK_Summerhouses PRIMARY KEY (Summerhouse id)
)
GO
...
(
  ...
  "Summerhouse Owner Contract id" int   NOT NULL,
  CONSTRAINT PK_Vacancy PRIMARY KEY (year, week)
)
GO
...
(
  ...
  CONSTRAINT PK_Zip Code and Town PRIMARY KEY (ZipCode id)
)
GO
...
ALTER TABLE Summerhouses
  ADD CONSTRAINT FK_District_TO_Summerhouses
    FOREIGN KEY (Area)
    REFERENCES District (Area id)
GO

ALTER TABLE Summerhouse owner
  ADD CONSTRAINT FK_Person_TO_Summerhouse owner
...
ALTER TABLE Summerhouse Owner Contract Relation
  ADD CONSTRAINT FK_Summerhouse owner_TO_Summerhouse Owner Contract Relation
...
ALTER TABLE Customer Rental Contract Relation
  ADD CONSTRAINT FK_Customer_TO_Customer Rental Contract Relation
    FOREIGN KEY (Customer id)
    REFERENCES Customer (Customer id)
GO

ALTER TABLE Customer Rental Contract Relation
  ADD CONSTRAINT FK_Customer consultant_TO_Customer Rental Contract Relation
...
ALTER TABLE Address
  ADD CONSTRAINT FK_Zip Code and Town_TO_Address
    FOREIGN KEY (ZipCode id)
    REFERENCES Zip Code and Town (ZipCode id)
GO

ALTER TABLE Summerhouses
  ADD CONSTRAINT FK_Summerhouse Owner Contract Relation_TO_Summerhouses
    FOREIGN KEY (Summerhouse Owner Contract id)
    REFERENCES Summerhouse Owner Contract Relation (Summerhouse Owner Contract id)
GO

ALTER TABLE Summerhouses
  ADD CONSTRAINT FK_Address_TO_Summerhouses
    FOREIGN KEY (Address id)
    REFERENCES Address (Address id)
GO

ALTER TABLE Summerhouses
  ADD CONSTRAINT FK_Independant overseer_TO_Summerhouses
    FOREIGN KEY (Independant overseer id)
    REFERENCES Independant overseer (Independant overseer id)
GO

ALTER TABLE Customer Rental Contract Relation
  ADD CONSTRAINT FK_Rental consultant_TO_Customer Rental Contract Relation
    FOREIGN KEY (Rental consultant id)
    REFERENCES Rental consultant (Rental consultant id)
GO

ALTER TABLE Summerhouse Owner Contract Relation
  ADD CONSTRAINT FK_Rental consultant_TO_Summerhouse Owner Contract Relation
    FOREIGN KEY (Rental consultant id)
    REFERENCES Rental consultant (Rental consultant id)
GO

ALTER TABLE Vacancy
  ADD CONSTRAINT FK_Summerhouses_TO_Vacancy
    FOREIGN KEY (Summerhouse id)
    REFERENCES Summerhouses (Summerhouse id)
GO

ALTER TABLE Vacancy
  ADD CONSTRAINT FK_Summerhouse Owner Contract Relation_TO_Vacancy
    FOREIGN KEY (Summerhouse Owner Contract id)
    REFERENCES Summerhouse Owner Contract Relation (Summerhouse Owner Contract id)
GO